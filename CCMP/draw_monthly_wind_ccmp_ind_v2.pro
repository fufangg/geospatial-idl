...
;==============================
pro draw_monthly_wind_ccmp_ind_v2
;==============================
;==========================================
...
pos_filename3=strpos(datanc[inc],'\uwnd'+year_st+month_st)
filename3=strtrim(strmid(datanc[inc],pos_filename3+5,23),2)
print, filename3  
;stop
;print,path_input
restore, datanc[inc]
u_map=monthly_map_u1
MAP_U=u_map
;restore,'E:\DATA IND V2\Olah\CCMP\Indonesia_V2\vwnd\Monthly\'+year_st+'\vwnd'+year_st+month_st+'.sav'
restore, '${filepath}.sav'
v_map=monthly_map_v1
MAP_V=v_map
